<div class="row form-custom-register center mt-4">
    <form action="../home/editinfor" method="post">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="input-field col s6">
                    <input id="hoten" type="text" class="validate" name="hoten" value="<?php echo $data['infortk']['TENHV']; ?>" required>
            ...
            <input type="hidden" name="id" value="<?php echo $data['infortk']['IDHV']; ?>">
            <div class="row">
                <button class="btn waves-effect waves-light indigo col s12" type="submmit" name="updatetk">Cập nhật</button>
                <a class="mt-2 col s12" href="/Nienluancoso/home/index">Quay lại</a>
            </div>
        </div>
    </form>
</div>