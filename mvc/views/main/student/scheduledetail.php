<div>
    ...
    <div class="m-5">
        ...
        <div class="row m-2">
            <a class="waves-effect waves-light btn indigo left" href="/Nienluancoso/schedule/couresschedule"><i class="fa-solid fa-backward"></i> Back</a>
            <a class="waves-effect waves-light btn red right" href="/Nienluancoso/registercoures/registercoures">Đăng ký ngay</a>
        </div>
    </div>
</div>