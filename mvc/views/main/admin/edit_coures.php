<div class="mt-3">
    ...
    <div class="mt-3">
        <form action="../../admin/submitedit" method="post" enctype="multipart/form-data">
            <div class="row">
            ...
            <a class="waves-effect waves-light btn indigo m-3 left" href="/Nienluancoso/admin/couresadmin"><i class="fa-solid fa-backward"></i> Back</a>
            <button class="btn waves-effect waves-light indigo right m-3" type="submit" name="chinhsua">Cập nhật
            </button>
        </form>
    </div>
