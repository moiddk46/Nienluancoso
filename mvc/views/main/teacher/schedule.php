<div>
    <h3 class="indigo-text text-darken-4 center"><b>Lịch dạy</b></h3>
    <div class="row">
        <h6 class="indigo-text text-darken-4 ">Lịch dạy của bạn:</h6>
        <?php
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="indigo-text text-darken-4 center">
                                ...
                                <td class="center"><a class="waves-effect waves-light btn indigo" href="/Nienluancoso/schedule/couresscheduledetailteacher/<?php echo $myschedule['IDLOP']; ?>"><i class="fa-solid fa-info"></i></a></td>
                            </tr>
                        <?php
                        }
                        ?>
    ...
    <div class="row">
        ...
        ?>
            <a class="col s2 m4" href="/Nienluancoso/schedule/schedulecoures/<?php echo $khoahoc['IDKH']; ?>">
                <div class="card">
